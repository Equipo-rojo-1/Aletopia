...
export class EmpleadosController {
    ...
    @Get(':cedula')
    getPersonBy(@Param('cedula') cedula: string): Promise<Person> {
        return this.personService.getPersonBy(cedula)
    }

    @Post('create')
    greatePerson(@Body() person: CreatePersonDto): Promise<Person> {
